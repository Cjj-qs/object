...
<body>
    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    <li class="active">
                        <a href="#"><i class="icon-calendar-month"></i> 类别管理 </a>
                        <ul>
                            <li><a href="form_layouts.html"> 浏览类别 </a></li>
            ...
            <div id="mws-navigation">
                <ul>
                    <li class="active">
                        ...
                        <ul>
                            <li><a href="form_layouts.html"> 浏览订单 </a></li>
                            <li><a href="form_elements.html"> 添加订单 </a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div id="mws-navigation">
                <ul>
                    <li class="active">
                        ...
                        <ul>
                            <li><a href="form_layouts.html"> 浏览商品 </a></li>
                            <li><a href="form_elements.html"> 添加商品 </a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div id="mws-navigation">
                <ul>
                    <li class="active">
                        <a href="#"><i class="icon-calendar"></i> 轮播图管理 </a>
                        <ul>
                            <li><a href="/admin/sow"> 浏览轮播图 </a></li>
                            <li><a href="/admin/sow/create"> 添加轮播图 </a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div id="mws-navigation">
                <ul>
                    <li class="active">
                        ...
                        <ul>
                            <li><a href="form_layouts.html"> 浏览链接 </a></li>
                            <li><a href="form_elements.html"> 添加链接 </a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="icons.html">
    ...
    <script src="/admin/custom-plugins/wizard/jquery.form.min.js"></script>
    ...
    <script src="/admin/js/demo/demo.wizard.js"></script>
